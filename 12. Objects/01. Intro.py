...
class Point:
    ...
    def perpendicular(self,other1,other2,other3):
        ...
        m1,c1 = self.line(other1)
        m2,c2 = other2.line(other3)
        if m1 == None and m2 == 0 or m1 == 0 and m2 == None:
            return True
        elif m1 == (-1/m2):
            return True
        return False
...
class Line:
    ...
    def point(self, x=None, y=None):
        ...
        elif self.m == None and x == None:
            from random import randrange
            x = self.x
            y = y = randrange(0,99999999)
    ...
    def isPerpendicular(self,other):
        ...
        if self.m == None and other.m == 0 or self.m == 0 and other.m == None:
            return True
...
class Rectangle:
    ...
    def within(self,*args):
        ...
        count = 0
        for arg in args:
            if (arg.x >= self.corner.x and
                arg.x <= self.corner.x+self.width and
                arg.y <= self.corner.y and
                arg.y >= self.corner.y-self.height): count += 1
    ...
    def collision(self,other):
        ...
        up = False
        down = False
        if other.corner.x < self.corner.x: left = True
        if other.corner.x > self.corner.x: right = True
        if other.corner.y > self.corner.y: up = True
        if other.corner.y < self.corner.y: down = True
        if (left and up and
            other.corner.y - other.height <= self.corner.y and
            other.corner.x + other.width >= self.corner.x): return True
        if (right and up and
            other.corner.y - other.height <= self.corner.y and
            other.corner.x <= self.corner.x + self.width): return True
        ...
        if (right and down and
            ...
            other.corner.y >= self.corner.y - self.height):return True
        return False
