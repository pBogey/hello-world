...
print("This program draws a square with the lower left corner at coordinates (x,y), of size lst")
...
def draw_square(x, y, l):
    """draws a square with the lower left corner at (x,y), of size lst"""
    x = arguments("Please input x coordinate: ")
    y = arguments("Please input y coordinate: ")
    l = arguments("Please input square size lst: ")
