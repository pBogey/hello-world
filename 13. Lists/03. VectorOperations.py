...
def test_vector_sum(vector1,vector2,vector3):
    ...
    if (vector_sum(vector1,vector2) == vector3 and
    vector_sum(vector1,vector2) == vector_sum(vector2,vector1) and
    vector_sum(vector1,vector_sum(vector2,vector3)) ==
    vector_sum(vector_sum(vector1,vector2),vector3)):
        print("Test passed!")
    else:
        print("Test failed!")
...
def test_vector_scalar_mult(vector1,scalar1,vector2):
    ...
    if (vector_scalar_mult(vector1,scalar1) == vector2 and
    vector_scalar_mult(vector1,1) == vector1 and
    vector_scalar_mult(vector1,0) == [0]*len(vector1) and
    vector_scalar_mult(vector_sum(vector1,vector2),scalar1) ==
    vector_sum(vector_scalar_mult(vector1,scalar1),
        vector_scalar_mult(vector2,scalar1))):
        print("Test passed!")
    else:
        print("Test failed!")
